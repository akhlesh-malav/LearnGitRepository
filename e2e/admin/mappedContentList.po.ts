...
mappedContentListLink(){
  return element(by.xpath('//*[@id="admin-nav"]/ul/li[7]/ul/li[2]/span'));
}
...
newContentMapButton(){
  return element(by.xpath('//*[@id="editor"]/div[1]/div[2]/button'));
}

selectCtaegoryForMapContentList(){
  return element(by.xpath('//*[@id="editor"]/div[1]/div[1]/span/div/select/option[2]'));
}

selectedMappedContentListData(){
  return element(by.xpath('//*[@id="editor"]/div[2]/table/tbody/tr[1]/td[1]')).getText();
}

deleteMappedContentDataList(){
  return element(by.xpath('//*[@id="editor"]/div[2]/table/tbody/tr[1]/td[4]/span'));
}

selectRowData(){
  return element(by.xpath('//*[@id="editor"]/div[2]/table/tbody/tr[1]/td[1]'));
}

updateContentTemplate(){
  return element(by.xpath('//*[@id="newmapping"]/div/div[1]/form/span[3]/select/option[9]'));
}

selectCategoryClick(){

  return element(by.xpath('//*[@id="editor"]/div[1]/div[1]/span/div/select'));
}
