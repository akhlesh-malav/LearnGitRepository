...
export class EnvisionAppPage {
  ...
  logoutLink(){
  	return  element(by.buttonText("/html/body/app-root/div/app-main-nav/nav/div/div[2]/div[2]/div[1]/div/button[2]"));
  }

  logoutLinkMenu(){
  	return element(by.xpath('//*[@id="admin-nav"]/ul/li[11]/ul/li/span'));
  }
